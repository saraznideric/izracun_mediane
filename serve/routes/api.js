...
connection.query(`INSERT INTO default.bankart (mediana) values (${mediana})`)
...
router.get('/mediana/get', function(req, res, next) {
  ...
  */
  ...
  connection.connect((error) => {
    ...
    connection.query(`SELECT * FROM default.bankart ORDER BY CREATED_AT`, (error, results, fields) => {
      if (error) {
